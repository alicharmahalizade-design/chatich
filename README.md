...
- **اسپات‌لایت دنبال‌کنندهٔ موس** روی پرتره + **دکمه‌های مغناطیسی** + **reveal کلمه‌به‌کلمهٔ** سرتیترها (سازگار با فارسی).
- **لایهٔ WebGL:** پس‌زمینهٔ دودِ طلایی/کاستیک روی GPU (نیم‌رزولوشن، ۳۰fps، فقط دسکتاپ) + **liquid hover** روی گیفت‌کارت‌ها.
