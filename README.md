...
## ارتقاهای سینمایی (نسخهٔ ۲)

- **درهای برنجی آسانسور:** بعد از پیش‌لودر، درها باز می‌شن و وارد Hero می‌شی؛ بین هر طبقه درها به‌صورت wipe بسته/باز می‌شن.
- **صحنهٔ پایانی:** پیش از فوتر، درها آرام بسته می‌شن، لوگو می‌مونه و جملهٔ «ساخته شده تا به یاد بماند» ظاهر می‌شه.
...
- **گالری Before/After** کشویی، **نظرات مهمان‌ها**، گرید **اینستاگرام**.
- **سوییچ فارسی/انگلیسی** با تغییر جهت صفحه (RTL↔LTR).
